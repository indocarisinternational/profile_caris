...
const DetailTeam = () => {
  ...
  return (
    ...
    >
      ...
      {(employee.work_experience || employee.education || employee.address) && (
          ...
          >
            ...
            <div className="inline-block p-4 bg-white rounded-lg shadow-inner">
              <img
                src={`${
                  import.meta.env.VITE_SUPABASE_URL
                }/storage/v1/object/public/employees/${employee.qr_code_url}`}
                alt={`${employee.full_name} QR Code`}
              ...
              <div
                style={{ display: "none" }}
                className="w-32 h-32 flex items-center justify-center bg-gray-200 rounded"
              >
